...
//   expect(str("App/Http/Controllers/Controller").afterLast("/").value()).toBe("Controller");
//   expect(str("Hello").append(" World").value()).toBe("Hello World");
//   expect(str("This is my name").before("my").value()).toBe("This is ");
//   expect(str("This is my name").beforeLast("is").value()).toBe("This ");
//   expect(str("This is my name").between("This", "name").value()).toBe(" is my ");
//   expect(str("foo_bar").camel().value()).toBe("fooBar");
//   expect(str("Hello").charAt(1).value()).toBe("e");
//   expect(str("https://laravel.com").chopStart("https://").value()).toBe("laravel.com");
...
//   expect(str("World").prepend("Hello ").value()).toBe("Hello World");
//   expect(str("Hello World").remove("llo").value()).toBe("He World");
//   expect(str("Hi").repeat(3).value()).toBe("HiHiHi");
//   expect(str("Hello World").replace("World", "Universe").value()).toBe("Hello Universe");
//   expect(str("The quick brown fox").replaceArray(["quick", "brown"], "lazy").value()).toBe("The lazy lazy fox");
//   expect(str("Hello World").replaceEnd("World", "Universe").value()).toBe("Hello Universe");
//   expect(str("Hello Hello World").replaceFirst("Hello", "Hi").value()).toBe("Hi Hello World");
//   expect(str("Hello Hello World").replaceLast("Hello", "Hi").value()).toBe("Hello Hi World");
//   expect(str("Hello World").replaceStart("Hello", "Hi").value()).toBe("Hi World");
// });
...
//   expect(str("Perfectly balanced, as all things should be.").words(3, ">>>").value()).toBe("Perfectly balanced, as>>>");
// });
