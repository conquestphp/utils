export const abbreviate = (number: number) => number.toLocaleString('en-US', {
    notation: 'compact',
...
export const format = (number: number, precision: number = 2, locale: string = 'en-US') => number.toLocaleString(locale, {
